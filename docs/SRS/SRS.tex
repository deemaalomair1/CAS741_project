...
\wss{spell check!} reactant in chemical reaction. The goal statements and
...
computing software proposed by [dParnas1972] and [parnasClements1984]. \wss{use
  citations in BibTeX for these.}  The presentation follows the standard pattern
