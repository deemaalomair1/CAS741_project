...
\begin{description}
\item[Secrets:] The format and structure of the valid inputs plus the software constraints.
...
\begin{description}
\item[Secrets:] How to get the atomic mass for each chemical element from the library.
